                      ...
                      <TextInput
                        ...
                        onChangeText={text => {
                          if (field.fieldtype === 'Int') {
                            ...
                            handleChange(field.fieldname, validInteger);
                          } else if (field.fieldtype === 'Float') {
                            // Allow floats with up to 3 decimal places
                            ...
                            handleChange(field.fieldname, cleaned);
                          } else {
                            handleChange(field.fieldname, text);
                          }
                        }}
                        onBlur={() => {
                          if (field.fieldtype === 'Float' && formData[field.fieldname]) {
                            ...
                            if (!isNaN(numValue)) {
                              handleChange(field.fieldname, numValue.toFixed(3));
                            }
                          }
                        }}
                      />
